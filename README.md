...
* [Using Git](notes/git_basics.md): How to pair program using git.
...
|:--:|:-----------------------------------------|:--|:--:|:--:|
| Monday | [**Register for AWS credit**][r-aws]<br/>[Development Workflow][workflow]<br/>  [Unix Tutorial][r-unix] <br/> [Unix for data science][r-unixfords] <br/> [Pair Programming][pairing] <br/> [**Git Remote**][gitremote] | [Readiness Assessment][learn0]<br/> [Unix Fundamental][unix]<br/>[Git][git] | Herbert/Jack/Hamid  | [AM][lec-fun]<br/>[PM][lec-git] |
