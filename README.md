...
|:---------:|:-------------------------------------------------------------------------------|:------------------------------------------------|    
| Monday    |Assessment 0<br>Orientation<br>[git][git]<br>[Unix][c1.1.1] (Denver branch)     |  [**Development Workflow**][r1.1.1]<br>[**Pair Programming**][r1.1.2]<br>[**A Taxonomy of Data Science**][r-tds]<br>[**Unix Philosophy**][1.1.3]|
